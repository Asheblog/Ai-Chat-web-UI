export const SYSTEM_SETTINGS_FIELD_MAP = {
  ...
  brandPrimaryForeground: 'brand_primary_foreground',
  brandBackground: 'brand_background',
  brandSurface: 'brand_surface',
  brandForeground: 'brand_foreground',
  brandMutedForeground: 'brand_muted_foreground',
  ...
  imageTranscriptionOllamaThink: 'image_transcription_ollama_think',
  imageTranscriptionReasoningEnabled: 'image_transcription_reasoning_enabled',
  imageTranscriptionReasoningEffort: 'image_transcription_reasoning_effort',
  ...
  webSearchApiKeyExa: 'web_search_api_key_exa',
  ...
  webSearchHasApiKeyExa: 'web_search_has_api_key_exa',
