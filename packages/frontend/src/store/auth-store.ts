...
export const useAuthStore = create<AuthStore>()(
  persist(
    (set, get) => {
      let fetchActorInFlight: Promise<void> | null = null
      ...
      return {
        ...
        fetchActor: async () => {
          if (fetchActorInFlight) return fetchActorInFlight
          set({ isLoading: true })
          fetchActorInFlight = (async () => {
            try {
              ...
              fetchActorInFlight = null
            }
          })()
          return fetchActorInFlight
        },
