...
export function SettingRow({
  ...
  return (
    <div
      className={cn(
        "rounded-lg border border-border/70 bg-card/85 px-4 py-4 shadow-[0_10px_24px_hsl(var(--background)/0.35)] sm:px-5 sm:py-4 flex flex-col gap-4 sm:flex-row sm:gap-6",
