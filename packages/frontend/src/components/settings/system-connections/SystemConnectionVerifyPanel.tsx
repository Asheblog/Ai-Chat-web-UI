  ...
  return (
    <Card className="border-border/70 bg-background/55 shadow-none">
      ...
      <CardContent className="space-y-3">
        {!verifyResult ? (
          <div className="rounded-2xl border border-dashed border-border/70 bg-background/60 px-4 py-6 text-sm leading-6 text-muted-foreground">
          ...
          <>
            ...
            <div className="space-y-3">
              {verifyResult.results.map((item, index) => {
                ...
                return (
                  <div key={resultKey} className="rounded-2xl border border-border/70 bg-background/70">
                    <button
                      type="button"
