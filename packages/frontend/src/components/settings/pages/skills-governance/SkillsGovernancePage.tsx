...
/**
 * Skill 治理页：待审批调用 / Skill 版本管理 / 绑定策略 三 section + 卸载预览 Dialog。
 * 由 SystemSkillsPage 迁移而来（Task 11），Skill 安装 section 已迁至工具与扩展页（Task 5），
 * 本页纯 API 驱动，无 settings key；三 section 为受控子组件，原样复用。
 */
...
export function SkillsGovernancePage() {
...
export default SkillsGovernancePage
