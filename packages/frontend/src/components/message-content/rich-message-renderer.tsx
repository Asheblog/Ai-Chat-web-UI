    ...
    >
      ...
      {hasImages && (
        <div className={cn('min-w-0', sideBySide && 'lg:col-span-5')}>
          <div className={cn('grid gap-3', imageParts.length > 1 ? 'grid-cols-1 sm:grid-cols-2' : 'grid-cols-1')}>
                ...
                >
                  ...
                  <div className="mt-3 flex flex-wrap gap-2 text-xs">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="rounded-md border border-border/70 px-2.5 py-1 hover:bg-muted"
                    >
                      查看原图
                    </a>
                    {image.sourceUrl && (
