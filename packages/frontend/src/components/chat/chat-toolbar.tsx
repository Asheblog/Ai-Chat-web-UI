...
export function ChatToolbar({ selectedModelId, onModelChange }: ChatToolbarProps) {
  return (
    <div className="hidden h-14 items-center border-b border-border/70 bg-[hsl(var(--background-alt))/0.86] px-4 backdrop-blur supports-[backdrop-filter]:bg-[hsl(var(--background-alt))/0.72] lg:flex">
