export const COMPOSER_SHELL_BASE_CLASS =
  'overflow-hidden rounded-[12px] border border-border bg-card/95 shadow-[0_18px_48px_hsl(var(--background)/0.45)] backdrop-blur-md transition-colors duration-200 focus-within:border-primary/40 focus-within:ring-2 focus-within:ring-ring/20 focus-within:ring-offset-2 focus-within:ring-offset-background'
