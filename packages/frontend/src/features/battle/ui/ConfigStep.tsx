                        ...
                        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                            {selectedModels.map((item) => {
                                ...
                                return (
                                    <div
                                        key={item.key}
                                        className="space-y-3 rounded-lg border border-border/70 bg-muted/30 p-4 transition-colors hover:border-primary/50"
                                    >
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            {availability.webSearchDisabledNote && (
                                                <p className="text-micro text-muted-foreground">{availability.webSearchDisabledNote}</p>
                                            )}
                                            ...
                                            {availability.pythonDisabledNote && (
                                                <p className="text-micro text-muted-foreground">{availability.pythonDisabledNote}</p>
                                            )}
                                        ...
                                        {item.advancedOpen && (
                                            <div className="space-y-3">
                                                <div className="space-y-2 rounded-lg border border-border/70 bg-card/80 p-3">
                                                    <div>
