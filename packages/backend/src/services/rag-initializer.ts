    ...
    try {
      ...
      const documentServices = createDocumentServices(prisma, {
        ...
        document: {
          ...
          ocrFallbackEnabled: settingsMap.rag_ocr_fallback_enabled?.toLowerCase() === 'true',
          ocrCommand: settingsMap.rag_ocr_command || process.env.RAG_OCR_COMMAND || 'ocrmypdf',
          ocrLanguage: settingsMap.rag_ocr_language || process.env.RAG_OCR_LANGUAGE || 'eng',
        },
        rag: {
